...
class CashierSerializer(serializers.ModelSerializer):
    ...
    def validate_name(self, value):
        ...
        if shop:
            ...
            if existing.exists():
                # Names can be duplicated - no error needed
                pass
        return value
    ...
    def validate_phone(self, value):
        ...
        if shop and value:
            ...
            if self.instance:
                existing = existing.exclude(id=self.instance.id)
            if existing.exists():
                # Phone numbers can be duplicated - no error needed
                pass
        return value
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'name', 'description', 'price', 'cost_price', 'currency', 'currency_display', 'price_type', 'price_type_display', 'category', 'line_code', 'stock_quantity', 'created_at', 'updated_at']
...
class ExpenseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Expense
        fields = ['id', 'expense_type', 'description', 'amount', 'currency', 'recorded_by', 'recorded_by_name', 'created_at']
...
class StockTakeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StockTake
        fields = ['id', 'name', 'status', 'started_by', 'started_by_name', 'completed_by',
                  'completed_by_name', 'started_at', 'completed_at', 'notes',
                  'total_products_counted', 'total_discrepancy_value', 'duration_display',
                  'items', 'summary', 'created_at', 'updated_at']
        read_only_fields = ['id', 'started_by_name', 'completed_by_name', 'duration_display',
                           'total_products_counted', 'total_discrepancy_value', 'created_at', 'updated_at']
