...
const ProductManagementScreen = () => {
  ...
  const handleAddProduct = async () => {
    ...
    try {
      ...
      console.log('📤 Sending add product request...', authData);
      const response = await shopAPI.addProduct(authData);
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      ...
      const response = await shopAPI.updateProduct(editingProduct.id, authData);
